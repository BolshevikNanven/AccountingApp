        ...
        switch (view) {
            case 'month': {
                ...
                return (
                    <div className="w-full h-full flex flex-col items-center custom">
                        <p
                            className={cn("w-1/2 h-[56%] rounded-[19px] flex flex-col justify-center items-center text-zinc-800 cursor-pointer transition-all hover:rounded-[27px]",
            ...
            case 'year': {
                ...
                return (
                    ...
                    >
                        <p className={cn("flex h-14 flex-col items-center text-2xl font-normal text-zinc-800 transition-all")}>
                            {day}
                            {outcount !== 0 && <p className=" text-emerald-500 text-sm">{outcount}</p>}
                            {incount !== 0 && <p className=" text-red-500 text-sm">+{incount}</p>}
                        </p>
    ...
    return (
        <div className="flex-1 flex flex-col h-full px-4 overflow-x-hidden">
            <MainHeader borderless title="流水日历">
                <div onClick={handleChangeView} className="px-3 h-8 flex flex-row items-center font-semibold cursor-pointer hover:bg-zinc-200 active:bg-zinc-300 rounded transition-colors mr-2">
